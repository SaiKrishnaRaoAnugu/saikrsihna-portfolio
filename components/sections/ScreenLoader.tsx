...
export default function ScreenLoader({ onDismiss }: Props) {
  ...
  function handleStart() {
    ...
    gsap.fromTo(line, { scaleX: 0, opacity: 0 }, { scaleX: 1, opacity: 1, duration: 0.25, ease: "power2.out" });
    gsap.to(top, { y: "-100%", duration: 1, ease: "expo.inOut", force3D: true });
    gsap.to(bottom, { y: "100%", duration: 1, ease: "expo.inOut", force3D: true });
    gsap.to(line, { opacity: 0, duration: 0.3, delay: 0.2 });
  ...
  return (
    <div ref={overlayRef} className={styles.overlay}>
      ...
      <p className={styles.monogram}>SAI KRISHNA RAO ANUGU</p>
